...
export default function ContactInfo() {
  ...
  const socials = [
    ...(facebook ? [{ icon: FaFacebookF, href: facebook, label: "ফেসবুক পেজ", color: "#3b5998" }] : []),
    ...(instagram ? [{ icon: FaInstagram, href: instagram, label: "ইনস্টাগ্রাম", color: "#8a3ab9" }] : []),
    ...(youtube ? [{ icon: FaYoutube, href: youtube, label: "ইউটিউব চ্যানেল", color: "#cd201f" }] : []),
  ];
