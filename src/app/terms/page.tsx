...
export const metadata = {
  title: "শর্তাবলী — মা ভেষজ বাণিজ্যালয়",
  description: "মা ভেষজ বাণিজ্যালয়ের ব্যবহারের শর্তাবলী সম্পর্কে জানুন।",
};
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-primary/5 border border-primary/15 rounded-2xl p-5 mb-10">
              <p className="text-text-body text-sm leading-relaxed">
                মা ভেষজ বাণিজ্যালয়ের ওয়েবসাইট ও সেবা ব্যবহার করার আগে অনুগ্রহ করে এই শর্তাবলী
            ...
            <div className="space-y-10">
              ...
              <div>
                ...
                <div className="pl-11 space-y-3 text-text-body text-sm leading-relaxed">
                  <p>
                    মা ভেষজ বাণিজ্যালয়ের সকল পণ্য ও সেবা ব্যবহারের ক্ষেত্রে নিম্নলিখিত
              ...
              <div>
                ...
                <div className="pl-11 space-y-3 text-text-body text-sm leading-relaxed">
                  ...
                  <ul className="space-y-2">
                    {[
                      "সকল ভেষজ পণ্য বিশ্বস্ত উৎস থেকে সংগ্রহ করা হয়।",
                      "পণ্য প্যাকেজিংয়ে মেয়াদ উত্তীর্ণের তারিখ স্পষ্টভাবে উল্লেখ থাকে।",
                      "মেয়াদ উত্তীর্ণ পণ্য বিক্রি করা হয় না।",
                      "প্রতিটি পণ্যের উপাদান সম্পর্কে সঠিক তথ্য প্রদান করা হয়।",
                      "পণ্যে কোনো ক্ষতিকর রাসায়নিক বা কৃত্রিম উপাদান নেই।",
                    ].map((item, i) => (
                      <li key={i} className="flex items-start gap-2 list-none">
                        <span className="w-1.5 h-1.5 bg-primary rounded-full mt-2 shrink-0" />
                        <span>{item}</span>
              ...
              <div>
                ...
                <div className="pl-11 space-y-3 text-text-body text-sm leading-relaxed">
                  ...
                  <div className="bg-background-alt border border-border rounded-xl p-4 mt-4">
                    ...
                    <p>ইমেইল: info@mavesoj.com | ফোন: +880 1731492117</p>
                  </div>
                </div>
              </div>
            </div>
