        ...
        <form onSubmit={handleSubmit} className="space-y-6 max-w-3xl">
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
            <div className="flex items-center gap-2 mb-4">
              <FiMail className="w-5 h-5 text-[#0f5931]" />
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input value={form.smtp_from || ""} onChange={set("smtp_from")} className={inputCls} placeholder="info@mavesoj.com" />
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
            ...
            <div>
              ...
              <input value={form.smtp_admin_email || ""} onChange={set("smtp_admin_email")} className={inputCls} placeholder="admin@mavesoj.com" />
