        ...
        {editReview && (
          <form onSubmit={handleEditSubmit} className="p-6 space-y-4">
            ...
            <div className="flex gap-3 pt-2">
              ...
              <button type="submit" disabled={editSaving} className="flex-1 py-2.5 bg-[#0f5931] text-white rounded-xl text-sm font-semibold hover:bg-[#12693a] transition-colors disabled:opacity-50">
